document.addEventListener("DOMContentLoaded", function() {
  ...
  var channels = ["esl_sc2", "ogamingsc2", "freecodecamp", "callofduty", "ghudda", "habathcx", "simCopter1", "lethalfrag", "noobs2ninjas", "beohoff", "a_seagull", "esl_overwatch", "clintstevens", "aimbotcalvin"];
  ...
  function getChannel(channel) {
    ...
    streamReq.setRequestHeader("client-id", "bbc7rm9c6jyejmuuo1oxn3jvcng6rxk");
    streamReq.onload = function() {
      ...
      if (data.error) {
        ...
        channelReq.setRequestHeader("client-id", "bbc7rm9c6jyejmuuo1oxn3jvcng6rxk");
